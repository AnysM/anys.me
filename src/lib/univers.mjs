...
export const UNIVERS = [
  ...
  { id: 'vivant', nom: 'Le lien au vivant', icon: '<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="3.4" stroke-linecap="round" stroke-linejoin="round"><path d="M24 35.5V8.5"/><path d="M24 27c-3.6-3.2-5.6-7.6-6-13.2-.1-1.6-.9-2.6-2-3.1"/><path d="M24 26.5c3.4-3 5.4-7.3 5.9-12.6.1-1.7 1-2.8 2.2-3.2"/><path d="M24 32c-5.5-1.4-10.2-4.6-12.8-9.6-.7-1.3-1.9-1.9-3.2-1.8"/><path d="M24 31.6c5.8-1.2 10.6-4.5 13.1-9.8.6-1.3 1.8-2 3.1-1.9"/><circle cx="24" cy="42.2" r="2.7" fill="currentColor" stroke="none"/></svg>' },
