...
const offres = defineCollection({
  ...
  schema: z.object({
    ...
    pourtoi_contre_titre: z.string().optional(),
    pourtoi_contre: z.array(z.string()).optional(),
    masques_titre: z.string().optional(),
    masques: z.array(z.string()).optional(),
    chemin_eyebrow: z.string().optional(),
    chemin_titre: z.string().optional(),
    chemin: z.string().optional(),
    chemin_appuis: z.array(z.string()).optional(),
    ...
    cadre_items: z.array(z.object({ titre: z.string(), cadence: z.string().optional(), texte: z.string() })).optional(),
