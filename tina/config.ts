    ...
    collections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "reconnaitre_eyebrow", label: "Ce qui revient souvent — sur-titre" },
          { type: "string", name: "reconnaitre_titre", label: "Ce qui revient souvent — titre", description: "*mot* = manuscrite" },
          { type: "string", name: "reconnaitre_items", label: "Ce qui revient souvent — situations", list: true },
          { type: "string", name: "reconnaitre_passage", label: "Ce qui revient souvent — phrase de fond", ui: { component: "textarea" } },
          ...
          { type: "string", name: "difference_eyebrow", label: "Ce qui change tout — sur-titre" },
          { type: "string", name: "difference_titre", label: "Ce qui change tout — titre", description: "*mot* = manuscrite" },
          { type: "object", name: "difference", label: "Ce qui change tout — les différences (3 idéalement)", list: true,
            ui: { itemProps: (i) => ({ label: i?.titre ?? "Différence" }) },
            fields: [
              { type: "string", name: "titre", label: "Titre court" },
              { type: "string", name: "texte", label: "Une ou deux phrases", ui: { component: "textarea" } },
            ] },
