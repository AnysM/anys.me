      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "pourqui_titre", label: "Pour qui — titre", description: "Par défaut : C'est *pour toi* si…" },
            ...
            { type: "string", name: "places", label: "Places (à côté du bouton)", description: "Ex. : **3** places pour entrer en novembre 2026" },
            ...
            { type: "string", name: "chemin_appuis", label: "Le chemin — les appuis", list: true, description: "Nom | lien (ex. : Les archétypes | /codex/archetypes)" },
